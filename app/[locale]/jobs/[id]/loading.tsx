export default function JobDetailLoading() {
  return (
    <div className="mx-auto w-full max-w-4xl animate-pulse px-4 py-10 sm:px-6">
      {/* Back link */}
      ...
      <div className="mt-6 flex flex-col gap-4 border-b border-border pb-8">
        <div className="flex gap-2">
          <div className="h-5 w-10 rounded-full bg-surface-raised" />
        ...
        <div className="mt-2 h-10 w-36 rounded-full bg-surface-raised" />
      </div>
